...
if ask 'Delete Kotoeri input method (for Japanese)?'; then
	sudo rm -rf /System/Library/Input\ Methods/Kotoeri.app
fi

if ask 'Delete KoreanIM input method?'; then
	sudo rm -rf /System/Library/Input\ Methods/KoreanIM.app
fi

if ask 'Delete VietnameseIM input method?'; then
	sudo rm -rf /System/Library/Input\ Methods/VietnameseIM.app
fi

if ask 'Delete TamilIM input method?'; then
	sudo rm -rf /System/Library/Input\ Methods/TamilIM.app
fi

if ask 'Delete Python 2.3?'; then
	sudo rm -rf /System/Library/Frameworks/Python.framework/Versions/2.3
	sudo rm -rf /Library/Python/2.3
fi

if ask 'Delete AirPort Utility.app?'; then
